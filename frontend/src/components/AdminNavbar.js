                            ...
                            <ul class="navbar-nav">
                                ...
                                <li className="nav-item dropdown">
                                    ...
                                    <ul className="dropdown-menu" aria-labelledby="servicesDropdown">
                                        ...
                                        <li>
                                            <Link to="/ShowAndRemoveAdmins" className="dropdown-item">System admins</Link>
                                        </li>
                                    </ul>
                                </li>
                                <li className="nav-item dropdown">
                                    ...
                                    <ul className="dropdown-menu" aria-labelledby="servicesDropdown">
                                        <li>
                                            <Link to="/ViewAndRemovePatients" className="dropdown-item">System patients</Link>
                                        </li>
                                ...
                                <li className="nav-item dropdown">
                                    ...
                                    <ul className="dropdown-menu" aria-labelledby="servicesDropdown">
                                        <li>
                                            <Link to="/ViewAndRemoveDoctors" className="dropdown-item">System doctors</Link>
                                        </li>
                                        <li>
                                            <Link to="/DoctorRegistrationRequests" className="dropdown-item">Doctor registration requests</Link>
                                        </li>
                                        <li>
                                            <Link to="/CreateContract" className="dropdown-item">Create a doctor contract</Link>
                                        </li>
                                ...
                                <li className="nav-item dropdown">
                                    ...
                                    <ul className="dropdown-menu" aria-labelledby="servicesDropdown">
                                        ...
                                        <li>
                                            <Link to="/HealthPackageUpdate" className="dropdown-item">Update health package</Link>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
